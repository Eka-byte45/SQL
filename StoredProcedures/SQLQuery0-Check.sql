...
--DELETE FROM Schedule WHERE discipline = (SELECT discipline_id FROM Disciplines WHERE discipline_name = 'Системное программирование');
...
--EXEC sp_InsertScheduleStacionar N'PV_521',N'',N'Олег',DEFAULT;
